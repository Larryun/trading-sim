...
export const DEFAULT_CAST: CastEntry[] = [
  ...
  ...rep(6, { type: 'marketMaker', capital: 600000 }),
  ...
  //   to the earnings-based fair value (the market's gravity). Do NOT shrink it without
  //   reading the anchor notes in CLAUDE.md — rebalancing capital away from value collapsed
  //   the market (tracking 99.9%, two-sided 10% of ticks).
  ...rep(5, { type: 'trader', capital: 1500000, style: 'value', note: 'long-only value' }),
