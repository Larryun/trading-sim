...
const PARAM_HELP: Record<string, string> = {
  ...
  'Net gamma': 'Simulated options gamma. NEGATIVE = short gamma → buys rallies / sells dips, amplifying the move (this is the squeeze). Positive = long gamma → fades moves and pins price to the strike.',
